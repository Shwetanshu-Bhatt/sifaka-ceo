  ...
  return (
    <main id="top">
      ...
      <section className="about section-pad" id="about">
        ...
        <div className="about-layout"><div className="about-art reveal" aria-hidden="true"><span className="small-label">THE WAY FORWARD IS BUILT.</span><div className="architecture"><span /><span /><span /><span /></div><span className="art-index">AMBITION / DIRECTION / ACTION</span></div><div className="about-copy reveal"><h2>See the whole.<br /><em>Own the details.</em></h2><p className="lead">I’m drawn to the messy, exciting space between “this could exist” and “here it is.”</p><p>At Sifaka Labs, I turn that curiosity into products. I care about the details people feel, the problems worth solving, and the people who make the whole thing possible.</p><p>Less standing on the sidelines. More rolling up sleeves. There’s always something interesting to build.</p><a className="text-link" href="#principles">A few things I believe <span>↘</span></a></div></div>
      </section>
